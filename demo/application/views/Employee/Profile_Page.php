            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <form class="form-horizontal" action="<?php echo base_url('Employee_Controller/updateprofile'); ?>" method="POST">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputName2" name="updatedepartment" placeholder="Dept">
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <form class="form-horizontal" action="<?php echo base_url('Employee_Controller/updatepassword'); ?>" method="post">
