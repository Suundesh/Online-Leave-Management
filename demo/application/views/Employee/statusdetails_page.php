              ...
              <form action="#">
                <div class="card-body">
                  <div class="form-group text-center">
                    <label><h1><?php echo $row->status;?></h1></label>
                  </div>
                  <div class="form-group">
                    <label >Leave From</label>
                    <input type="text" class="form-control" id="" value="<?php echo $row->leavefrom;?>" disabled>
                  </div>
                  <div class="form-group">
                    <label >Leave Upto</label>
                    <input type="text" class="form-control" id="" value="<?php echo $row->leaveto;?>" disabled>
                  </div>
                  <div class="form-group">
                    <label>Number Of Days</label>
                    <input type="text" class="form-control" id="" value="<?php echo $row->numofdays;?>" disabled>
                  </div>
                  <div class="form-group">
                    <label>Leave Type</label>
                    <input type="text" class="form-control" id="" value="<?php echo $row->leavetype;?>" disabled>
                  </div>
                  <div class="card">
                  ...
                  <label>Admin Remarks</label>
                    <textarea class="form-control" name="" id="" cols="40" rows="3" disabled><?php echo $row->adminremark;?></textarea>
                  </div>
                </div>
                <div class="card-footer ">
                <!-- <a href="<?php echo base_url('Employee_Controller/retriveapplication/'.$row->presentdataid)?>" class="btn btn-danger float-right">Retrive Application</a> -->
                  <!-- <button type="submit" class="btn btn-danger float-right">Retrieve Application</button> -->
                </div>
              </form>
            </div>
            <!-- /.card -->
